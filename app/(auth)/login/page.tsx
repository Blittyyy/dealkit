    ...
    <div className="rounded-[18px] bg-white shadow-[0_25px_60px_rgba(0,0,0,0.45)] border border-white/5 animate-auth-fade-in">
      <div className="p-8 lg:p-10">
        <div className="space-y-2 mb-8">
          ...
          <p className="text-[15px] text-muted/90 leading-relaxed">
            Sign in to manage your verified media kit.
          </p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-5 pt-1">
              ...
              <div className="relative pt-2">
                ...
                <div className="relative flex justify-center text-xs pt-4">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full h-12 text-sm font-medium border-border-soft hover:bg-[#E6E8EC]/40"
